...
const LOCAL_FILE = path.resolve(__dirname, '../../server-backup/.env');
const REMOTE_PATH = '/.env';

async function main() {
  console.log(`🚀 Connessione all'FTP per il deploy di .env...`);
  ...
  try {
    ...
    console.log('✅ Deploy di .env completato con successo!');
  } catch (err) {
